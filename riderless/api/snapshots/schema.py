...
SNAPSHOT_PROTOCOL = "riderless-snapshot-v1"
...
class WorkerHello(StrictModel):
    type: Literal["hello"]
    protocol: Literal["riderless-snapshot-v1"]
    profile: Literal["split18-30-v1"]
    model_id: Literal["local-gemma-riderless-v1"]
    ...
    context_prompt_version: Literal["riderless-gemma-context-v1"]
    generated_tokens: Literal[0]
    callbacks_enabled: Literal[False]
