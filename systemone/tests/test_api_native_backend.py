...
from systemone.api.compiler import CompiledBatch, compile_request
from systemone.api.native_backend import NativeBackend
from systemone.api.schema import BackendProfile, SystemOneRequest
...
print(json.dumps({'type':'hello','protocol_version':2,
 'model_id':'local-gemma-systemone-v1','model_name':'fixture',
