...
from systemone.api.compiler import PROMPT_VERSION, compile_request
from systemone.api.mapping import map_response, stable_softmax
...
def test_compiler_rejects_cardinality_above_backend_capacity() -> None:
    ...
    with pytest.raises(ValueError, match="capacity"):
        compile_request(SystemOneRequest.model_validate(payload), PROFILE)
