...
each run's own probabilities.
    ...
    python scripts/unridden/compare_competitor_outcomes.py \
        --left outputs/usecase-suites-v041/observations.jsonl \
        --right outputs/competitor-kev-v1/observations.jsonl \
        --left-name unridden-v041 --right-name kev-9b \
        --out outputs/competitor-kev-v1/outcome-diff-vs-unridden-v041.json
"""
