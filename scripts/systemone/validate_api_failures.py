    ...
    *,
    ...
    async with (
        ...
        httpx.AsyncClient(
            ...
            base_url="http://systemone-failures",
            timeout=None,
        ) as client,
    ):
        ...
        if kill_child:
            warm = await client.post("/v1/systemone", json=payload(1))
        ...
        failed = await client.post("/v1/systemone", json=payload(8))
        ...
        after = await client.post("/v1/systemone", json=payload(1))
