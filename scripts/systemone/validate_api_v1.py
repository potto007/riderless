...
FROZEN_CASES_SHA256 = "8c75fa2f5088c8ea8a71f4f95aa91ffd1f84b9b8e5983c7ed6ab61ffb3cb2bb9"
TOLERANCE = 1e-6
...
async def run(args: argparse.Namespace) -> None:
    ...
    native_logger = logging.getLogger("systemone.api.native")
    ...
    async def request(
        ...
        *,
        ...
        response = await client.post(
            "/v1/systemone?diagnostics=true", **(options or {"json": payload})
        )
    ...
    try:
        async with app.router.lifespan_context(app):
            ...
            async with httpx.AsyncClient(
                ...
                base_url="http://systemone-validation",
                timeout=None,
            ) as client:
...
def main() -> None:
    ...
    parser.add_argument(
        "--cases", type=Path, default=Path("systemone/examples/api-v1-cases.json")
    )
