...
For software vulnerabilities, use the private reporting route in the
...
This policy retains that license separately from the repository's Apache-2.0
software license.

See the [Contributor Covenant FAQ](https://www.contributor-covenant.org/faq/)
for background and [translations](https://www.contributor-covenant.org/translations/).
